### Code to create interaction plots for PJ cover predictors (additive density model)
...
load("R:/Shriver_Lab/PJcover/Density.RData")
...
predict_fun <- function(coef=betaOut_dd,heatload=heatload_mean,ppt=ppt_mean,tmax=tmax_mean,ppt_dev=ppt_dev_mean,tmax_dev=tmax_dev_mean,dens=dens_mean){
...
png(file="./Output/Interactions_dd.png",9,7,units="in",type="cairo",res=600)
grid.newpage()
